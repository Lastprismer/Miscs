...
\end{align}
$$
为 **推理的形式结构** ，$A_1, A_2, A_3\dotsA_k$ 为推理的 **前提** ， $B$ 为 **结论** 。若推理的形式结构 $(*)$ 为永真式，则称推理正确，否则称推理不正确。
...
3. **量词辖域收缩与扩张式（$B$ 中不含 $x$）**
   ...
   $\vee$ 也可为 $\wedge, \rightarrow$，也可是 $B \rightarrow A(x)$，量词也可为 $\exist$
